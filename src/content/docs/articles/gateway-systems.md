...
Full API management suites answer an even wider question. Akana, Amazon API Gateway, Apigee, Azure API Management, Kong Enterprise, and products like them package gateway behavior with lifecycle management, plans, subscriptions, developer portals, analytics, monetization, approvals, and governance workflows.
